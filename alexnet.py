...
class AlexNet(object):
    ...
    def create(self):
        ...
        fc7 = fc(dropout6, 4096, 2048, name='fc7')
...
def convolve(i, k, stride_y, stride_x, padding):
...
def conv(x, filter_height, filter_width, num_filters, stride_y, stride_x, name,
    ...
    if groups == 1:
        conv = convolve(x, weights, stride_y, stride_x, padding)
    ...
    # In the cases of multiple groups, split inputs & weights and
        ...
        weight_groups = tf.split(axis=3, num_or_size_splits=groups,
                                 value=weights)
        output_groups = [convolve(i, k, stride_y, stride_x, padding) for i, k in zip(input_groups, weight_groups)]
